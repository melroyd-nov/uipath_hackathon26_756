# Claude.md — Acme Call Center Analytics 
...
We are building the **Acme Call Center Analytics** platform on **UiPath**.
...
| `Docs/PROJECT_SUMMARY.md` | As-built UiPath-native documentation | ✅ Complete |
...
These are hardcoded in the existing system and must be preserved:
