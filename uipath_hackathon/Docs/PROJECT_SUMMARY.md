...
> Reflects the actual codebase as-built. No UiPath branding applied.
...
- Also runs several `ALTER TABLE ... ADD COLUMN IF NOT EXISTS` statements to handle schema migrations without a migration tool
